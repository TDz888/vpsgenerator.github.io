 ...
 * Token hợp lệ phải bắt đầu bằng: github_pat_, ghp_, gho_, ghu_, ghs_
 */
...
/**
 * Kiểm tra tên repository hợp lệ theo quy tắc GitHub
...
export async function validateGitHubToken(token) {
  ...
  if (!isValidGitHubTokenFormat(token)) {
    return { 
      valid: false, 
      error: 'Token GitHub không đúng định dạng. Token phải bắt đầu bằng "github_pat_" hoặc "ghp_". Vui lòng tạo token mới tại https://github.com/settings/tokens'
    };
  }
